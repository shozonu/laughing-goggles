...
public class CreateCoffeeDB
{
        ...
        try
            {
                ...
                // If the DB already exists, drop the tables.  since
                //we are going to create the table, we completely
                //delete all the tables and all information about them
                //first (if any)

                //see definition of method dropTables below
                dropTables(conn);
    ...
    /**
     * The dropTables method drops any existing tables
        ...
        try
            {
                ...
                try
                    ...
                    {
                        System.out.println("UnpaidOrder table does not exist, so nothing to drop.");
                ...
                try
                    ...
                    {
                        System.out.println("Customer table does not exist, so nothing to drop.");
                        // No need to report an error.
                        // The table simply did not exist.
                    }
                ...
                try
                    ...
                    {
                        System.out.println("Coffe table does not exist, so nothing to drop.");
                        // No need to report an error.
                        // The table simply did not exist.
                    }
            }
